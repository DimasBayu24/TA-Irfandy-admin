import { IResourceComponentsProps, useCustom, useList, useApiUrl } from '@pankod/refine-core';
import {
  Create,
  Form,
  DatePicker,
...
import { ITalent, IUser, IRole } from 'interfaces';

export const TalentCreate: React.FC<IResourceComponentsProps> = () => {
